...
- Document how to build a custom annotation database from NCBI Virus, and fix stale `customisation/databases.md` cross-references left over from a docs restructure ([#318](https://github.com/nf-core/viralmetagenome/pull/318)) (by @Joon-Klaps)
