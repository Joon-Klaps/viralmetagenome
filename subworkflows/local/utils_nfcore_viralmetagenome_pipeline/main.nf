...
* Software dependencies
    https://github.com/nf-core/viralmetagenome/blob/main/CITATIONS.md
"""
    if (monochrome_logs) {
    ...
    channel
        ...
        .map {
            meta, fastq_1, fastq_2 ->
                ...
                if (!fastq_2) {
                    return [ meta.id, meta + [ sample: sample_id, single_end:true ], [ fastq_1 ] ]
                } else {
                    return [ meta.id, meta + [ sample: sample_id, single_end:false ], [ fastq_1, fastq_2 ] ]
                }
        }
        .groupTuple()
        .map { samplesheet ->
